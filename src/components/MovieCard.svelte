<script lang="ts">
  ...
  function handleClick() {
      dispatch('openModal', movie); // Mengirimkan event ke parent
  }
</script>

<div class="card relative h-[367px] w-60 flex-shrink-0 flex items-end justify-start text-left bg-cover bg-center rounded-2xl cursor-pointer"
