...
<main class="mx-8 md:mx-16 lg:mx-[80px] pt-6 items-center">
  <!-- Hero Section -->
  <div class="relative h-[545px] w-full flex items-center text-left bg-cover bg-center rounded-2xl"
    ...
    <div class="flex flex-col justify-between w-full h-full py-16 mx-11">
        ...
        {#if !errorPopular && homeMovies.length > 0}
          <div class=" md:px-7 z-10 flex flex-col items-start gap-2 max-w-[402px]">
            <p class="line-clamp-2 text-ellipsis overflow-hidden font-normal text-white text-xl">
              {getGenreNames(popularMovies[activeMovieIndex].genre_ids)}
            </p>
